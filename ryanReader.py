...
def reader(booklet):
    ...
    choices = 4
    #booklet 1-4 answers
    ans1 = [1,2,1,0,1,2,3,3,1,1]
    ans2 = [2,1,0,0,3,1,3,0,1,2]
    ans3 = [3,1,1,3,2,1,0,1,0,0]
    ans4 = [0,1,3,0,3,3,0,2,2,3]

    options1 = [["Honey","Pizza","Orange","Bubble Gum"],
        [],
        [],
        [],
        [],
    ...
    options2 = [[],
        ...
        [],
        [],]
    options3 = [["Flower","Rubber Tire", "Chocolate", "Fish"],
        ["Cotton Candy", "Onion", "Natural Gas", "Chili"],
        ["Fish","Peach","Leather","Pizza"],
        ["Garlic","Watermelon","Licorice","Smoke"],
        ["Pineapple", "Dill Pickle","Apple","Chocolate"],
        ["Smoke", "Popcorn", "Pineapple","Onion"],
        ["Vanilla", "Garlic", "Peach", "Rubber Tire"],
        ["Rubber Tire", "Orange", "Cheddar Cheese", "Tobacco"],
        ["Mint", "Apple", "Fish","Leather"],
        ["Coffee", "Menthol", "Peanut", "Watermelon"]]
    options4 = [[],
        [],
        [],
        [],
    ...
    strAns1 = ["Pizza","Bubble Gum","Menthol","Cherry","Motor Oil","Mint","Banana","Clove","Leather","Coconut"]
    strAns2 = ["Onion","Raspberry","Licorice","Baby Powder","Cinnamon","Gasoline","Strawberry","Cedar","Chocolate","Wintergreen Gum"]
    strAns3 = ["Flower","Cotton Candy","Peach","Garlic","Dill Pickle","Pineapple","Rubber Tire","Orange","Apple","Watermelon"]
    strAns4 = ["Sandalwood","Grass","Smoke","Pine","Grape Candy","Lemon","Soap","Natural Gas","Rose","Peanut"]
